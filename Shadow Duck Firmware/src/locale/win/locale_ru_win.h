...
const uint8_t combinations_ru_win[] = {
};

static hid_locale_t locale_ru_win {
    (uint8_t*)ascii_ru_win, 128,
    (uint8_t*)utf8_ru_win, sizeof(utf8_ru_win) / 6,
    (uint8_t*)combinations_ru_win, sizeof(combinations_ru_win) / 8,
};