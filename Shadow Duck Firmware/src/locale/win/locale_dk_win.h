...
const uint8_t combinations_dk_win[] = {
...
static hid_locale_t locale_dk_win {
    (uint8_t*)ascii_dk_win, 128,
    (uint8_t*)utf8_dk_win, sizeof(utf8_dk_win) / 6,
    (uint8_t*)combinations_dk_win, sizeof(combinations_dk_win) / 8,
};