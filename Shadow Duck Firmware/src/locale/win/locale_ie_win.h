...
const uint8_t combinations_ie_win[] = {
    0xC2, 0xB4, 0x00, 0x00, KEY_MOD_RALT,           KEY_APOSTROPHE,     KEY_NONE,           KEY_SPACE,          // ´
    0xC3, 0x80, 0x00, 0x00, KEY_NONE,               KEY_GRAVE,          KEY_MOD_LSHIFT,     KEY_A,              // À
    0xC3, 0x88, 0x00, 0x00, KEY_NONE,               KEY_GRAVE,          KEY_MOD_LSHIFT,     KEY_E,              // È
    0xC3, 0x8C, 0x00, 0x00, KEY_NONE,               KEY_GRAVE,          KEY_MOD_LSHIFT,     KEY_I,              // Ì
    0xC3, 0x92, 0x00, 0x00, KEY_NONE,               KEY_GRAVE,          KEY_MOD_LSHIFT,     KEY_O,              // Ò
    0xC3, 0x99, 0x00, 0x00, KEY_NONE,               KEY_GRAVE,          KEY_MOD_LSHIFT,     KEY_U,              // Ù
    0xC3, 0x9D, 0x00, 0x00, KEY_MOD_RALT,           KEY_APOSTROPHE,     KEY_MOD_LSHIFT,     KEY_Y,              // Ý
    0xC3, 0xA0, 0x00, 0x00, KEY_NONE,               KEY_GRAVE,          KEY_NONE,           KEY_A,              // à
    0xC3, 0xA8, 0x00, 0x00, KEY_NONE,               KEY_GRAVE,          KEY_NONE,           KEY_E,              // è
    0xC3, 0xAC, 0x00, 0x00, KEY_NONE,               KEY_GRAVE,          KEY_NONE,           KEY_I,              // ì
    0xC3, 0xB2, 0x00, 0x00, KEY_NONE,               KEY_GRAVE,          KEY_NONE,           KEY_O,              // ò
    0xC3, 0xB9, 0x00, 0x00, KEY_NONE,               KEY_GRAVE,          KEY_NONE,           KEY_U,              // ù
    0xC3, 0xBD, 0x00, 0x00, KEY_MOD_RALT,           KEY_APOSTROPHE,     KEY_NONE,           KEY_Y,              // ý
};

static hid_locale_t locale_ie_win {
    (uint8_t*)ascii_ie_win, 128,
    (uint8_t*)utf8_ie_win, sizeof(utf8_ie_win) / 6,
    (uint8_t*)combinations_ie_win, sizeof(combinations_ie_win) / 8,
};