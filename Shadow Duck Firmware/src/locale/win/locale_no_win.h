...
const uint8_t combinations_no_win[] = {
    ...
    0x7E, 0x00, 0x00, 0x00, KEY_MOD_RALT,           KEY_RIGHTBRACE,     KEY_NONE,           KEY_SPACE,          // ~
    0xC2, 0xA8, 0x00, 0x00, KEY_NONE,               KEY_RIGHTBRACE,     KEY_NONE,           KEY_SPACE,          // ¨
    0xC2, 0xB4, 0x00, 0x00, KEY_MOD_RALT,           KEY_EQUAL,          KEY_NONE,           KEY_SPACE,          // ´
    0xC3, 0x80, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_EQUAL,          KEY_MOD_LSHIFT,     KEY_A,              // À
    0xC3, 0x81, 0x00, 0x00, KEY_MOD_RALT,           KEY_EQUAL,          KEY_MOD_LSHIFT,     KEY_A,              // Á
    0xC3, 0x82, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_RIGHTBRACE,     KEY_MOD_LSHIFT,     KEY_A,              // Â
    0xC3, 0x83, 0x00, 0x00, KEY_MOD_RALT,           KEY_RIGHTBRACE,     KEY_MOD_LSHIFT,     KEY_A,              // Ã
    ...
    0xC3, 0x89, 0x00, 0x00, KEY_MOD_RALT,           KEY_EQUAL,          KEY_MOD_LSHIFT,     KEY_E,              // É
    ...
    0xC3, 0x8D, 0x00, 0x00, KEY_MOD_RALT,           KEY_EQUAL,          KEY_MOD_LSHIFT,     KEY_I,              // Í
    ...
    0xC3, 0x91, 0x00, 0x00, KEY_MOD_RALT,           KEY_RIGHTBRACE,     KEY_MOD_LSHIFT,     KEY_N,              // Ñ
    0xC3, 0x92, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_EQUAL,          KEY_MOD_LSHIFT,     KEY_O,              // Ò
    0xC3, 0x93, 0x00, 0x00, KEY_MOD_RALT,           KEY_EQUAL,          KEY_MOD_LSHIFT,     KEY_O,              // Ó
    0xC3, 0x94, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_RIGHTBRACE,     KEY_MOD_LSHIFT,     KEY_O,              // Ô
    0xC3, 0x95, 0x00, 0x00, KEY_MOD_RALT,           KEY_RIGHTBRACE,     KEY_MOD_LSHIFT,     KEY_O,              // Õ
    ...
    0xC3, 0x9A, 0x00, 0x00, KEY_MOD_RALT,           KEY_EQUAL,          KEY_MOD_LSHIFT,     KEY_U,              // Ú
    ...
    0xC3, 0x9D, 0x00, 0x00, KEY_MOD_RALT,           KEY_EQUAL,          KEY_MOD_LSHIFT,     KEY_Y,              // Ý
    0xC3, 0xA0, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_EQUAL,          KEY_NONE,           KEY_A,              // à
    0xC3, 0xA1, 0x00, 0x00, KEY_MOD_RALT,           KEY_EQUAL,          KEY_NONE,           KEY_A,              // á
    0xC3, 0xA2, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_RIGHTBRACE,     KEY_NONE,           KEY_A,              // â
    0xC3, 0xA3, 0x00, 0x00, KEY_MOD_RALT,           KEY_RIGHTBRACE,     KEY_NONE,           KEY_A,              // ã
    ...
    0xC3, 0xA9, 0x00, 0x00, KEY_MOD_RALT,           KEY_EQUAL,          KEY_NONE,           KEY_E,              // é
    ...
    0xC3, 0xAD, 0x00, 0x00, KEY_MOD_RALT,           KEY_EQUAL,          KEY_NONE,           KEY_I,              // í
    ...
    0xC3, 0xB1, 0x00, 0x00, KEY_MOD_RALT,           KEY_RIGHTBRACE,     KEY_NONE,           KEY_N,              // ñ
    0xC3, 0xB2, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_EQUAL,          KEY_NONE,           KEY_O,              // ò
    0xC3, 0xB3, 0x00, 0x00, KEY_MOD_RALT,           KEY_EQUAL,          KEY_NONE,           KEY_O,              // ó
    0xC3, 0xB4, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_RIGHTBRACE,     KEY_NONE,           KEY_O,              // ô
    0xC3, 0xB5, 0x00, 0x00, KEY_MOD_RALT,           KEY_RIGHTBRACE,     KEY_NONE,           KEY_O,              // õ
    ...
    0xC3, 0xBA, 0x00, 0x00, KEY_MOD_RALT,           KEY_EQUAL,          KEY_NONE,           KEY_U,              // ú
    ...
    0xC3, 0xBD, 0x00, 0x00, KEY_MOD_RALT,           KEY_EQUAL,          KEY_NONE,           KEY_Y,              // ý
    0xC3, 0xBF, 0x00, 0x00, KEY_NONE,               KEY_RIGHTBRACE,     KEY_NONE,           KEY_Y,              // ÿ
};

static hid_locale_t locale_no_win {
    (uint8_t*)ascii_no_win, 128,
    (uint8_t*)utf8_no_win, sizeof(utf8_no_win) / 6,
    (uint8_t*)combinations_no_win, sizeof(combinations_no_win) / 8,
};