...
const uint8_t combinations_hu_win[] = {
...
static hid_locale_t locale_hu_win {
    (uint8_t*)ascii_hu_win, 128,
    (uint8_t*)utf8_hu_win, sizeof(utf8_hu_win) / 6,
    (uint8_t*)combinations_hu_win, sizeof(combinations_hu_win) / 8,
};