...
const uint8_t combinations_ch_de_win[] = {
...
static hid_locale_t locale_ch_de_win {
    (uint8_t*)ascii_ch_de_win, 128,
    (uint8_t*)utf8_ch_de_win, sizeof(utf8_ch_de_win) / 6,
    (uint8_t*)combinations_ch_de_win, sizeof(combinations_ch_de_win) / 8,
};