...
const uint8_t utf8_ua_win[] = {
    ...
    0xE2, 0x82, 0xB4, 0x00, KEY_MOD_LSHIFT,         KEY_GRAVE,          // ₴
    0xE2, 0x84, 0x96, 0x00, KEY_MOD_LSHIFT,         KEY_3,              // №
};

const uint8_t combinations_ua_win[] = {
};

static hid_locale_t locale_ua_win {
    (uint8_t*)ascii_ua_win, 128,
    (uint8_t*)utf8_ua_win, sizeof(utf8_ua_win) / 6,
    (uint8_t*)combinations_ua_win, sizeof(combinations_ua_win) / 8,
};