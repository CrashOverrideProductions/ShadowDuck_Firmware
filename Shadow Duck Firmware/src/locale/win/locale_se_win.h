...
const uint8_t combinations_se_win[] = {
...
static hid_locale_t locale_se_win {
    (uint8_t*)ascii_se_win, 128,
    (uint8_t*)utf8_se_win, sizeof(utf8_se_win) / 6,
    (uint8_t*)combinations_se_win, sizeof(combinations_se_win) / 8,
};