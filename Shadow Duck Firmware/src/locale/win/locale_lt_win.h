...
const uint8_t ascii_lt_win[] = {
    ...
    // 32, 0x20
    KEY_NONE,           KEY_SPACE,          // ' '
    (KEY_MOD_RALT|KEY_MOD_LSHIFT),KEY_1,    // !
    KEY_MOD_LSHIFT,     KEY_APOSTROPHE,     // "
    (KEY_MOD_RALT|KEY_MOD_LSHIFT),KEY_3,    // #

    // 36, 0x24
    (KEY_MOD_RALT|KEY_MOD_LSHIFT),KEY_4,    // $
    (KEY_MOD_RALT|KEY_MOD_LSHIFT),KEY_5,    // %
    (KEY_MOD_RALT|KEY_MOD_LSHIFT),KEY_7,    // &
    KEY_NONE,           KEY_APOSTROPHE,     // '

    // 40, 0x28
    KEY_MOD_LSHIFT,     KEY_9,              // (
    KEY_MOD_LSHIFT,     KEY_0,              // )
    (KEY_MOD_RALT|KEY_MOD_LSHIFT),KEY_8,    // *
    (KEY_MOD_RALT|KEY_MOD_LSHIFT),KEY_EQUAL,// +
    ...
    // 48, 0x30
    KEY_NONE,           KEY_0,              // 0
    KEY_MOD_RALT,       KEY_1,              // 1
    KEY_MOD_RALT,       KEY_2,              // 2
    KEY_MOD_RALT,       KEY_3,              // 3

    // 52, 0x34
    KEY_MOD_RALT,       KEY_4,              // 4
    KEY_MOD_RALT,       KEY_5,              // 5
    KEY_MOD_RALT,       KEY_6,              // 6
    KEY_MOD_RALT,       KEY_7,              // 7

    // 56, 0x38
    KEY_MOD_RALT,       KEY_8,              // 8
    KEY_NONE,           KEY_9,              // 9
    ...
    // 64, 0x40
    (KEY_MOD_RALT|KEY_MOD_LSHIFT),KEY_2,    // @
    ...
    (KEY_MOD_RALT|KEY_MOD_LSHIFT),KEY_6,    // ^
...
const uint8_t combinations_lt_win[] = {
};

static hid_locale_t locale_lt_win {
    (uint8_t*)ascii_lt_win, 128,
    (uint8_t*)utf8_lt_win, sizeof(utf8_lt_win) / 6,
    (uint8_t*)combinations_lt_win, sizeof(combinations_lt_win) / 8,
};