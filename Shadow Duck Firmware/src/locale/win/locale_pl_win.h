...
const uint8_t utf8_pl_win[] = {
    0xC3, 0x93, 0x00, 0x00, (KEY_MOD_RALT|KEY_MOD_LSHIFT), KEY_O,       // Ó
    0xC3, 0xB3, 0x00, 0x00, KEY_MOD_RALT,           KEY_O,              // ó
    0xC4, 0x84, 0x00, 0x00, (KEY_MOD_RALT|KEY_MOD_LSHIFT), KEY_A,       // Ą
    0xC4, 0x85, 0x00, 0x00, KEY_MOD_RALT,           KEY_A,              // ą
    0xC4, 0x86, 0x00, 0x00, (KEY_MOD_RALT|KEY_MOD_LSHIFT), KEY_C,       // Ć
    0xC4, 0x87, 0x00, 0x00, KEY_MOD_RALT,           KEY_C,              // ć
    0xC4, 0x98, 0x00, 0x00, (KEY_MOD_RALT|KEY_MOD_LSHIFT), KEY_E,       // Ę
    0xC4, 0x99, 0x00, 0x00, KEY_MOD_RALT,           KEY_E,              // ę
    0xC5, 0x81, 0x00, 0x00, (KEY_MOD_RALT|KEY_MOD_LSHIFT), KEY_L,       // Ł
    0xC5, 0x82, 0x00, 0x00, KEY_MOD_RALT,           KEY_L,              // ł
    0xC5, 0x83, 0x00, 0x00, (KEY_MOD_RALT|KEY_MOD_LSHIFT), KEY_N,       // Ń
    0xC5, 0x84, 0x00, 0x00, KEY_MOD_RALT,           KEY_N,              // ń
    0xC5, 0x9A, 0x00, 0x00, (KEY_MOD_RALT|KEY_MOD_LSHIFT), KEY_S,       // Ś
    0xC5, 0x9B, 0x00, 0x00, KEY_MOD_RALT,           KEY_S,              // ś
    0xC5, 0xB9, 0x00, 0x00, (KEY_MOD_RALT|KEY_MOD_LSHIFT), KEY_X,       // Ź
    0xC5, 0xBA, 0x00, 0x00, KEY_MOD_RALT,           KEY_X,              // ź
    0xC5, 0xBB, 0x00, 0x00, (KEY_MOD_RALT|KEY_MOD_LSHIFT), KEY_Z,       // Ż
    0xC5, 0xBC, 0x00, 0x00, KEY_MOD_RALT,           KEY_Z,              // ż
    0xE2, 0x82, 0xAC, 0x00, KEY_MOD_RALT,           KEY_U,              // €
};

const uint8_t combinations_pl_win[] = {
    0x7E, 0x00, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_GRAVE,          KEY_NONE,           KEY_SPACE,          // ~
};

static hid_locale_t locale_pl_win {
    (uint8_t*)ascii_pl_win, 128,
    (uint8_t*)utf8_pl_win, sizeof(utf8_pl_win) / 6,
    (uint8_t*)combinations_pl_win, sizeof(combinations_pl_win) / 8,
};