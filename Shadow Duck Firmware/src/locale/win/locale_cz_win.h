...
const uint8_t combinations_cz_win[] = {
...
static hid_locale_t locale_cz_win {
    (uint8_t*)ascii_cz_win, 128,
    (uint8_t*)utf8_cz_win, sizeof(utf8_cz_win) / 6,
    (uint8_t*)combinations_cz_win, sizeof(combinations_cz_win) / 8,
};