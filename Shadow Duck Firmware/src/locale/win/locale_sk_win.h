...
const uint8_t combinations_sk_win[] = {
    ...
    0xC5, 0xAF, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_GRAVE,          KEY_NONE,           KEY_U,              // ů
...
static hid_locale_t locale_sk_win {
    (uint8_t*)ascii_sk_win, 128,
    (uint8_t*)utf8_sk_win, sizeof(utf8_sk_win) / 6,
    (uint8_t*)combinations_sk_win, sizeof(combinations_sk_win) / 8,
};