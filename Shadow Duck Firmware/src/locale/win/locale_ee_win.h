...
const uint8_t combinations_ee_win[] = {
...
static hid_locale_t locale_ee_win {
    (uint8_t*)ascii_ee_win, 128,
    (uint8_t*)utf8_ee_win, sizeof(utf8_ee_win) / 6,
    (uint8_t*)combinations_ee_win, sizeof(combinations_ee_win) / 8,
};