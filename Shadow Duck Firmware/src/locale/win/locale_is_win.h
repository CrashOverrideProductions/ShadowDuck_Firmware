...
const uint8_t utf8_is_win[] = {
    0xC2, 0xB0, 0x00, 0x00, KEY_NONE,               KEY_GRAVE,          // °
...
const uint8_t combinations_is_win[] = {
    0x5E, 0x00, 0x00, 0x00, KEY_MOD_RALT,           KEY_APOSTROPHE,     KEY_NONE,           KEY_SPACE,          // ^
    ...
    0xC3, 0x8F, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_GRAVE,          KEY_MOD_LSHIFT,     KEY_I,              // Ï
    ...
    0xC3, 0x94, 0x00, 0x00, KEY_MOD_RALT,           KEY_APOSTROPHE,     KEY_MOD_LSHIFT,     KEY_O,              // Ô
    ...
    0xC3, 0xAF, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_GRAVE,          KEY_NONE,           KEY_I,              // ï
    ...
    0xC3, 0xB4, 0x00, 0x00, KEY_MOD_RALT,           KEY_APOSTROPHE,     KEY_NONE,           KEY_O,              // ô
    ...
    0xC3, 0xBF, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_GRAVE,          KEY_NONE,           KEY_Y,              // ÿ
};

static hid_locale_t locale_is_win {
    (uint8_t*)ascii_is_win, 128,
    (uint8_t*)utf8_is_win, sizeof(utf8_is_win) / 6,
    (uint8_t*)combinations_is_win, sizeof(combinations_is_win) / 8,
};