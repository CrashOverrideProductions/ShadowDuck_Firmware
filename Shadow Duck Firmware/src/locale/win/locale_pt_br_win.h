...
const uint8_t utf8_pt_br_win[] = {
    ...
    0xE2, 0x82, 0xA2, 0x00, KEY_MOD_RALT,           KEY_C,              // ₢
};

const uint8_t combinations_pt_br_win[] = {
    ...
    0xC2, 0xA8, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_6,              KEY_NONE,           KEY_SPACE,          // ¨
...
static hid_locale_t locale_pt_br_win {
    (uint8_t*)ascii_pt_br_win, 128,
    (uint8_t*)utf8_pt_br_win, sizeof(utf8_pt_br_win) / 6,
    (uint8_t*)combinations_pt_br_win, sizeof(combinations_pt_br_win) / 8,
};