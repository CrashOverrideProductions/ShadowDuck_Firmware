...
const uint8_t combinations_be_win[] = {
...
static hid_locale_t locale_be_win {
    (uint8_t*)ascii_be_win, 128,
    (uint8_t*)utf8_be_win, sizeof(utf8_be_win) / 6,
    (uint8_t*)combinations_be_win, sizeof(combinations_be_win) / 8,
};