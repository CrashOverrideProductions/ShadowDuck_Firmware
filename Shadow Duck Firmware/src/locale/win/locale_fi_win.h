...
const uint8_t combinations_fi_win[] = {
...
static hid_locale_t locale_fi_win {
    (uint8_t*)ascii_fi_win, 128,
    (uint8_t*)utf8_fi_win, sizeof(utf8_fi_win) / 6,
    (uint8_t*)combinations_fi_win, sizeof(combinations_fi_win) / 8,
};