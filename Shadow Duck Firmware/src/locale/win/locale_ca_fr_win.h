...
const uint8_t combinations_ca_fr_win[] = {
...
static hid_locale_t locale_ca_fr_win {
    (uint8_t*)ascii_ca_fr_win, 128,
    (uint8_t*)utf8_ca_fr_win, sizeof(utf8_ca_fr_win) / 6,
    (uint8_t*)combinations_ca_fr_win, sizeof(combinations_ca_fr_win) / 8,
};