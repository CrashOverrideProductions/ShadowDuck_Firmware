...
const uint8_t combinations_fr_win[] = {
...
static hid_locale_t locale_fr_win {
    (uint8_t*)ascii_fr_win, 128,
    (uint8_t*)utf8_fr_win, sizeof(utf8_fr_win) / 6,
    (uint8_t*)combinations_fr_win, sizeof(combinations_fr_win) / 8,
};