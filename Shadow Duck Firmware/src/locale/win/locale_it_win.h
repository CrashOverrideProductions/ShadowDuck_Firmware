...
const uint8_t combinations_it_win[] = {
};

static hid_locale_t locale_it_win {
    (uint8_t*)ascii_it_win, 128,
    (uint8_t*)utf8_it_win, sizeof(utf8_it_win) / 6,
    (uint8_t*)combinations_it_win, sizeof(combinations_it_win) / 8,
};