...
const uint8_t ascii_ua_mac[] = {
    ...
    // 96, 0x60
    (KEY_MOD_LALT|KEY_MOD_LSHIFT),KEY_0,    // `
    KEY_NONE,           KEY_NONE,           // a
    KEY_NONE,           KEY_NONE,           // b
    KEY_NONE,           KEY_NONE,           // c
    ...
    KEY_NONE,           KEY_NONE,           // y
    KEY_NONE,           KEY_NONE,           // z
    (KEY_MOD_LALT|KEY_MOD_LSHIFT),KEY_H,    // {

    // 124, 0x7c
    (KEY_MOD_LALT|KEY_MOD_LSHIFT),KEY_1,    // |
    KEY_MOD_LALT,       KEY_H,              // }
    KEY_MOD_LALT,       KEY_M,              // ~
    KEY_NONE,           KEY_DELETE          // DEL
};

const uint8_t utf8_ua_mac[] = {
    0xC2, 0xA3, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_3,       // £
    0xC2, 0xA7, 0x00, 0x00, KEY_MOD_LALT,           KEY_GRAVE,          // §
    0xC2, 0xA9, 0x00, 0x00, KEY_MOD_LALT,           KEY_G,              // ©
    0xC2, 0xAB, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_EQUAL,   // «
    0xC2, 0xAC, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_6,       // ¬
    0xC2, 0xAE, 0x00, 0x00, KEY_MOD_LALT,           KEY_R,              // ®
    0xC2, 0xB0, 0x00, 0x00, KEY_MOD_LALT,           KEY_J,              // °
    0xC2, 0xB1, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_GRAVE,   // ±
    0xC2, 0xB5, 0x00, 0x00, KEY_MOD_LALT,           KEY_V,              // µ
    0xC2, 0xB6, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_7,       // ¶
    0xC2, 0xBB, 0x00, 0x00, KEY_MOD_LALT,           KEY_EQUAL,          // »
    0xC3, 0xB7, 0x00, 0x00, KEY_MOD_LALT,           KEY_F,              // ÷
    0xC6, 0x92, 0x00, 0x00, KEY_MOD_LALT,           KEY_A,              // ƒ
    0xCA, 0xBC, 0x00, 0x00, KEY_NONE,               KEY_BACKSLASH,      // ʼ
    0xD0, 0x81, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_T,       // Ё
    0xD0, 0x82, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_Z,       // Ђ
    0xD0, 0x84, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_APOSTROPHE,     // Є
    0xD0, 0x85, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_I,       // Ѕ
    0xD0, 0x86, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_S,              // І
    0xD0, 0x87, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_RIGHTBRACE,     // Ї
    0xD0, 0x88, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_Q,       // Ј
    0xD0, 0x89, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_K,       // Љ
    0xD0, 0x8A, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_Y,       // Њ
    0xD0, 0x8B, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_D,       // Ћ
    0xD0, 0x8C, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_E,       // Ќ
    0xD0, 0x8E, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_O,       // Ў
    0xD0, 0x8F, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_W,       // Џ
    ...
    0xD0, 0xAA, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_RIGHTBRACE, // Ъ
    0xD0, 0xAB, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_S,       // Ы
    0xD0, 0xAC, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_M,              // Ь
    0xD0, 0xAD, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_APOSTROPHE, // Э
    ...
    0xD1, 0x8A, 0x00, 0x00, KEY_MOD_LALT,           KEY_RIGHTBRACE,     // ъ
    0xD1, 0x8B, 0x00, 0x00, KEY_MOD_LALT,           KEY_S,              // ы
    0xD1, 0x8C, 0x00, 0x00, KEY_NONE,               KEY_M,              // ь
    0xD1, 0x8D, 0x00, 0x00, KEY_MOD_LALT,           KEY_APOSTROPHE,     // э
    0xD1, 0x8E, 0x00, 0x00, KEY_NONE,               KEY_DOT,            // ю
    0xD1, 0x8F, 0x00, 0x00, KEY_NONE,               KEY_Z,              // я
    0xD1, 0x91, 0x00, 0x00, KEY_MOD_LALT,           KEY_T,              // ё
    0xD1, 0x92, 0x00, 0x00, KEY_MOD_LALT,           KEY_Z,              // ђ
    0xD1, 0x94, 0x00, 0x00, KEY_NONE,               KEY_APOSTROPHE,     // є
    0xD1, 0x95, 0x00, 0x00, KEY_MOD_LALT,           KEY_I,              // ѕ
    0xD1, 0x96, 0x00, 0x00, KEY_NONE,               KEY_S,              // і
    0xD1, 0x97, 0x00, 0x00, KEY_NONE,               KEY_RIGHTBRACE,     // ї
    0xD1, 0x98, 0x00, 0x00, KEY_MOD_LALT,           KEY_Q,              // ј
    0xD1, 0x99, 0x00, 0x00, KEY_MOD_LALT,           KEY_K,              // љ
    0xD1, 0x9A, 0x00, 0x00, KEY_MOD_LALT,           KEY_Y,              // њ
    0xD1, 0x9B, 0x00, 0x00, KEY_MOD_LALT,           KEY_D,              // ћ
    0xD1, 0x9C, 0x00, 0x00, KEY_MOD_LALT,           KEY_E,              // ќ
    0xD1, 0x9E, 0x00, 0x00, KEY_MOD_LALT,           KEY_O,              // ў
    0xD1, 0x9F, 0x00, 0x00, KEY_MOD_LALT,           KEY_W,              // џ
    0xD2, 0x90, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_102ND,          // Ґ
    0xD2, 0x91, 0x00, 0x00, KEY_NONE,               KEY_102ND,          // ґ
    0xE2, 0x80, 0x93, 0x00, KEY_MOD_LALT,           KEY_MINUS,          // –
    0xE2, 0x80, 0x94, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_MINUS,   // —
    0xE2, 0x80, 0x98, 0x00, KEY_MOD_LALT,           KEY_P,              // ‘
    0xE2, 0x80, 0x99, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_P,       // ’
    0xE2, 0x80, 0x9C, 0x00, KEY_MOD_LALT,           KEY_LEFTBRACE,      // “
    0xE2, 0x80, 0x9D, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_LEFTBRACE, // ”
    0xE2, 0x80, 0x9E, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_SLASH,   // „
    0xE2, 0x80, 0xA2, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_J,       // •
    0xE2, 0x80, 0xA6, 0x00, KEY_MOD_LALT,           KEY_SEMICOLON,      // …
    0xE2, 0x82, 0xAC, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_4,       // €
    0xE2, 0x82, 0xB4, 0x00, KEY_MOD_LSHIFT,         KEY_BACKSLASH,      // ₴
    0xE2, 0x84, 0x96, 0x00, KEY_MOD_LSHIFT,         KEY_3,              // №
    0xE2, 0x84, 0xA2, 0x00, KEY_MOD_LALT,           KEY_N,              // ™
    0xE2, 0x88, 0x86, 0x00, KEY_MOD_LALT,           KEY_L,              // ∆
    0xE2, 0x88, 0x9A, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_8,       // √
    0xE2, 0x88, 0x9E, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_5,       // ∞
    0xE2, 0x89, 0x88, 0x00, KEY_MOD_LALT,           KEY_X,              // ≈
    0xE2, 0x89, 0xA0, 0x00, KEY_MOD_LALT,           KEY_C,              // ≠
    0xE2, 0x89, 0xA4, 0x00, KEY_MOD_LALT,           KEY_COMMA,          // ≤
    0xE2, 0x89, 0xA5, 0x00, KEY_MOD_LALT,           KEY_DOT,            // ≥
};

const uint8_t combinations_ua_mac[] = {
};

static hid_locale_t locale_ua_mac {
    (uint8_t*)ascii_ua_mac, 128,
    (uint8_t*)utf8_ua_mac, sizeof(utf8_ua_mac) / 6,
    (uint8_t*)combinations_ua_mac, sizeof(combinations_ua_mac) / 8,
};