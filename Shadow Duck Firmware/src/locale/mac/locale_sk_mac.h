...
const uint8_t utf8_sk_mac[] = {
    0xC2, 0xA3, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_4,       // £
    0xC2, 0xA7, 0x00, 0x00, KEY_NONE,               KEY_APOSTROPHE,     // §
    0xC2, 0xA8, 0x00, 0x00, KEY_MOD_LALT,           KEY_BACKSLASH,      // ¨
    0xC2, 0xA9, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_C,       // ©
    0xC2, 0xAB, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_9,       // «
    0xC2, 0xAC, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_1,       // ¬
    0xC2, 0xAE, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_R,       // ®
    0xC2, 0xB6, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_7,       // ¶
    0xC2, 0xBB, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_0,       // »
    ...
    0xC3, 0xB7, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_8,       // ÷
    ...
    0xC4, 0x96, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_W,       // Ė
    0xC4, 0x97, 0x00, 0x00, KEY_MOD_LALT,           KEY_W,              // ė
    0xC4, 0x98, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_E,       // Ę
    0xC4, 0x99, 0x00, 0x00, KEY_MOD_LALT,           KEY_E,              // ę
    ...
    0xC5, 0xBB, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_Y,       // Ż
    0xC5, 0xBC, 0x00, 0x00, KEY_MOD_LALT,           KEY_Y,              // ż
    ...
    0xE2, 0x80, 0x98, 0x00, KEY_MOD_LALT,           KEY_H,              // ‘
    0xE2, 0x80, 0x99, 0x00, KEY_MOD_LALT,           KEY_J,              // ’
    0xE2, 0x80, 0x9A, 0x00, KEY_MOD_LALT,           KEY_N,              // ‚
    0xE2, 0x80, 0x9C, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_H,       // “
    0xE2, 0x80, 0x9D, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_J,       // ”
    0xE2, 0x80, 0x9E, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_N,       // „
    0xE2, 0x80, 0xA0, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_6,       // †
    0xE2, 0x80, 0xA2, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_2,       // •
    0xE2, 0x80, 0xBA, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_RIGHTBRACE, // ›
    0xE2, 0x82, 0xAC, 0x00, KEY_MOD_LALT,           KEY_R,              // €
    ...
    0xE2, 0x89, 0xA0, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_3,       // ≠
    0xE2, 0x89, 0xA4, 0x00, KEY_MOD_LALT,           KEY_GRAVE,          // ≤
    0xE2, 0x89, 0xA5, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_GRAVE,   // ≥
    0xE2, 0x97, 0x8A, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_5,       // ◊
};

const uint8_t combinations_sk_mac[] = {
    0xC2, 0xB0, 0x00, 0x00, KEY_MOD_LALT,           KEY_MINUS,          KEY_NONE,           KEY_SPACE,          // °
    0xC3, 0x81, 0x00, 0x00, KEY_NONE,               KEY_EQUAL,          KEY_MOD_LSHIFT,     KEY_A,              // Á
    0xC3, 0x84, 0x00, 0x00, KEY_MOD_LALT,           KEY_BACKSLASH,      KEY_MOD_LSHIFT,     KEY_A,              // Ä
    ...
    0xC3, 0x94, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_EQUAL,          KEY_MOD_LSHIFT,     KEY_O,              // Ô
    0xC3, 0x95, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_APOSTROPHE, KEY_MOD_LSHIFT,  KEY_O,              // Õ
    0xC3, 0x96, 0x00, 0x00, KEY_MOD_LALT,           KEY_BACKSLASH,      KEY_MOD_LSHIFT,     KEY_O,              // Ö
    0xC3, 0x9A, 0x00, 0x00, KEY_NONE,               KEY_EQUAL,          KEY_MOD_LSHIFT,     KEY_U,              // Ú
    0xC3, 0x9C, 0x00, 0x00, KEY_MOD_LALT,           KEY_BACKSLASH,      KEY_MOD_LSHIFT,     KEY_U,              // Ü
    0xC3, 0xB3, 0x00, 0x00, KEY_NONE,               KEY_EQUAL,          KEY_NONE,           KEY_O,              // ó
    0xC3, 0xB5, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_APOSTROPHE, KEY_NONE,        KEY_O,              // õ
    0xC3, 0xB6, 0x00, 0x00, KEY_MOD_LALT,           KEY_BACKSLASH,      KEY_NONE,           KEY_O,              // ö
    0xC3, 0xBC, 0x00, 0x00, KEY_MOD_LALT,           KEY_BACKSLASH,      KEY_NONE,           KEY_U,              // ü
    ...
    0xC4, 0x9B, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_EQUAL,          KEY_NONE,           KEY_E,              // ě
    0xC4, 0xB9, 0x00, 0x00, KEY_NONE,               KEY_EQUAL,          KEY_MOD_LSHIFT,     KEY_L,              // Ĺ
    0xC4, 0xBA, 0x00, 0x00, KEY_NONE,               KEY_EQUAL,          KEY_NONE,           KEY_L,              // ĺ
    0xC4, 0xBB, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_MINUS,   KEY_MOD_LSHIFT,     KEY_L,              // Ļ
    0xC4, 0xBC, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_MINUS,   KEY_NONE,           KEY_L,              // ļ
    ...
    0xC5, 0x85, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_MINUS,   KEY_MOD_LSHIFT,     KEY_N,              // Ņ
    0xC5, 0x86, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_MINUS,   KEY_NONE,           KEY_N,              // ņ
    0xC5, 0x87, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_EQUAL,          KEY_MOD_LSHIFT,     KEY_N,              // Ň
    0xC5, 0x90, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_BACKSLASH, KEY_MOD_LSHIFT,   KEY_O,              // Ő
    0xC5, 0x91, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_BACKSLASH, KEY_NONE,         KEY_O,              // ő
    0xC5, 0x94, 0x00, 0x00, KEY_NONE,               KEY_EQUAL,          KEY_MOD_LSHIFT,     KEY_R,              // Ŕ
    0xC5, 0x95, 0x00, 0x00, KEY_NONE,               KEY_EQUAL,          KEY_NONE,           KEY_R,              // ŕ
    0xC5, 0x96, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_MINUS,   KEY_MOD_LSHIFT,     KEY_R,              // Ŗ
    0xC5, 0x97, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_MINUS,   KEY_NONE,           KEY_R,              // ŗ
    0xC5, 0x98, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_EQUAL,          KEY_MOD_LSHIFT,     KEY_R,              // Ř
    0xC5, 0x99, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_EQUAL,          KEY_NONE,           KEY_R,              // ř
    ...
    0xC5, 0xAE, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_EQUAL,          KEY_MOD_LSHIFT,     KEY_U,              // Ů
    0xC5, 0xAF, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_EQUAL,          KEY_NONE,           KEY_U,              // ů
    0xC5, 0xB0, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_BACKSLASH, KEY_MOD_LSHIFT,   KEY_U,              // Ű
    0xC5, 0xB1, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_BACKSLASH, KEY_NONE,         KEY_U,              // ű
    0xC5, 0xB2, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_MINUS,   KEY_MOD_LSHIFT,     KEY_U,              // Ų
    0xC5, 0xB3, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_MINUS,   KEY_NONE,           KEY_U,              // ų
...
static hid_locale_t locale_sk_mac {
    (uint8_t*)ascii_sk_mac, 128,
    (uint8_t*)utf8_sk_mac, sizeof(utf8_sk_mac) / 6,
    (uint8_t*)combinations_sk_mac, sizeof(combinations_sk_mac) / 8,
};