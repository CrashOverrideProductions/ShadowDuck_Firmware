...
const uint8_t combinations_cz_mac[] = {
    ...
    0xC3, 0xB4, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_EQUAL,          KEY_NONE,           KEY_O,              // ô
    ...
    0xC4, 0xA2, 0x00, 0x00, KEY_NONE,               KEY_EQUAL,          KEY_MOD_LSHIFT,     KEY_G,              // Ģ
    0xC4, 0xA3, 0x00, 0x00, KEY_NONE,               KEY_EQUAL,          KEY_NONE,           KEY_G,              // ģ
    0xC4, 0xAE, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_MINUS,   KEY_MOD_LSHIFT,     KEY_I,              // Į
    0xC4, 0xAF, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_MINUS,   KEY_NONE,           KEY_I,              // į
...
static hid_locale_t locale_cz_mac {
    (uint8_t*)ascii_cz_mac, 128,
    (uint8_t*)utf8_cz_mac, sizeof(utf8_cz_mac) / 6,
    (uint8_t*)combinations_cz_mac, sizeof(combinations_cz_mac) / 8,
};