...
const uint8_t utf8_se_mac[] = {
    ...
    0xC2, 0xB4, 0x00, 0x00, KEY_MOD_LALT,           KEY_EQUAL,          // ´
    ...
    0xC3, 0x98, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_SEMICOLON, // Ø
    ...
    0xC3, 0xB8, 0x00, 0x00, KEY_MOD_LALT,           KEY_SEMICOLON,      // ø
    ...
    0xCB, 0x87, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_X,       // ˇ
    ...
    0xE2, 0x84, 0xA2, 0x00, KEY_MOD_LALT,           KEY_BACKSLASH,      // ™
...
const uint8_t combinations_se_mac[] = {
    ...
    0xC5, 0xB8, 0x00, 0x00, KEY_NONE,               KEY_RIGHTBRACE,     KEY_MOD_LSHIFT,     KEY_Y,              // Ÿ
};

static hid_locale_t locale_se_mac {
    (uint8_t*)ascii_se_mac, 128,
    (uint8_t*)utf8_se_mac, sizeof(utf8_se_mac) / 6,
    (uint8_t*)combinations_se_mac, sizeof(combinations_se_mac) / 8,
};