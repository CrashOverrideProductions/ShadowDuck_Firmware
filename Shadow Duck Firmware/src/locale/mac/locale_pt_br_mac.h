...
const uint8_t utf8_pt_br_mac[] = {
    ...
    0xC2, 0xB4, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_E,       // ´
    ...
    0xC3, 0x82, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_M,       // Â
    ...
    0xEF, 0xAC, 0x82, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_6,       // ﬂ
};

const uint8_t combinations_pt_br_mac[] = {
    ...
    0xC3, 0x80, 0x00, 0x00, KEY_NONE,               KEY_102ND,          KEY_MOD_LSHIFT,     KEY_A,              // À
    0xC3, 0x83, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_102ND,          KEY_MOD_LSHIFT,     KEY_A,              // Ã
    0xC3, 0x84, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_APOSTROPHE,     KEY_MOD_LSHIFT,     KEY_A,              // Ä
    0xC3, 0x88, 0x00, 0x00, KEY_NONE,               KEY_102ND,          KEY_MOD_LSHIFT,     KEY_E,              // È
    ...
    0xC3, 0x8C, 0x00, 0x00, KEY_NONE,               KEY_102ND,          KEY_MOD_LSHIFT,     KEY_I,              // Ì
    0xC3, 0x91, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_102ND,          KEY_MOD_LSHIFT,     KEY_N,              // Ñ
    0xC3, 0x95, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_102ND,          KEY_MOD_LSHIFT,     KEY_O,              // Õ
    0xC3, 0x96, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_APOSTROPHE,     KEY_MOD_LSHIFT,     KEY_O,              // Ö
    0xC3, 0x99, 0x00, 0x00, KEY_NONE,               KEY_102ND,          KEY_MOD_LSHIFT,     KEY_U,              // Ù
    ...
    0xC3, 0xAC, 0x00, 0x00, KEY_NONE,               KEY_102ND,          KEY_NONE,           KEY_I,              // ì
    ...
    0xC3, 0xB1, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_102ND,          KEY_NONE,           KEY_N,              // ñ
    0xC3, 0xB2, 0x00, 0x00, KEY_NONE,               KEY_102ND,          KEY_NONE,           KEY_O,              // ò
    0xC3, 0xB3, 0x00, 0x00, KEY_NONE,               KEY_APOSTROPHE,     KEY_NONE,           KEY_O,              // ó
    0xC3, 0xB4, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_6,              KEY_NONE,           KEY_O,              // ô
    0xC3, 0xB5, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_102ND,          KEY_NONE,           KEY_O,              // õ
    0xC3, 0xB6, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_APOSTROPHE,     KEY_NONE,           KEY_O,              // ö
    0xC3, 0xB9, 0x00, 0x00, KEY_NONE,               KEY_102ND,          KEY_NONE,           KEY_U,              // ù
...
static hid_locale_t locale_pt_br_mac {
    (uint8_t*)ascii_pt_br_mac, 128,
    (uint8_t*)utf8_pt_br_mac, sizeof(utf8_pt_br_mac) / 6,
    (uint8_t*)combinations_pt_br_mac, sizeof(combinations_pt_br_mac) / 8,
};