...
const uint8_t combinations_fi_mac[] = {
...
static hid_locale_t locale_fi_mac {
    (uint8_t*)ascii_fi_mac, 128,
    (uint8_t*)utf8_fi_mac, sizeof(utf8_fi_mac) / 6,
    (uint8_t*)combinations_fi_mac, sizeof(combinations_fi_mac) / 8,
};