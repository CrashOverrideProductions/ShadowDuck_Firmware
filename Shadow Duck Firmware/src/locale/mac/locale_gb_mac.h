...
const uint8_t combinations_gb_mac[] = {
...
static hid_locale_t locale_gb_mac {
    (uint8_t*)ascii_gb_mac, 128,
    (uint8_t*)utf8_gb_mac, sizeof(utf8_gb_mac) / 6,
    (uint8_t*)combinations_gb_mac, sizeof(combinations_gb_mac) / 8,
};