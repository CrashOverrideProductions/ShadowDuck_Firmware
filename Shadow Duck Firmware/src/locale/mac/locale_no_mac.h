...
const uint8_t utf8_no_mac[] = {
    ...
    0xC5, 0xB8, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_GRAVE,   // Ÿ
    0xC6, 0x92, 0x00, 0x00, KEY_MOD_LALT,           KEY_F,              // ƒ
    0xCB, 0x86, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_I,       // ˆ
    0xCB, 0x98, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_H,       // ˘
    0xCB, 0x99, 0x00, 0x00, KEY_MOD_LALT,           KEY_LEFTBRACE,      // ˙
    0xCB, 0x9A, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_LEFTBRACE, // ˚
    0xCB, 0x9B, 0x00, 0x00, KEY_MOD_LALT,           KEY_H,              // ˛
    0xCB, 0x9C, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_Y,       // ˜
    0xCB, 0x9D, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_W,       // ˝
    ...
    0xE2, 0x80, 0x98, 0x00, KEY_MOD_LALT,           KEY_N,              // ‘
    0xE2, 0x80, 0x99, 0x00, KEY_MOD_LALT,           KEY_M,              // ’
    0xE2, 0x80, 0x9A, 0x00, KEY_MOD_LALT,           KEY_COMMA,          // ‚
    0xE2, 0x80, 0x9C, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_N,       // “
    0xE2, 0x80, 0x9D, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_M,       // ”
    ...
    0xE2, 0x81, 0x84, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_Z,       // ⁄
    ...
    0xE2, 0x88, 0xAB, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_F,       // ∫
    0xE2, 0x89, 0x88, 0x00, KEY_MOD_LALT,           KEY_0,              // ≈
    ...
    0xEF, 0xA3, 0xBF, 0x00, KEY_MOD_LALT,           KEY_A,              // 
    0xEF, 0xAC, 0x81, 0x00, KEY_MOD_LALT,           KEY_L,              // ﬁ
    0xEF, 0xAC, 0x82, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_L,       // ﬂ
};

const uint8_t combinations_no_mac[] = {
...
static hid_locale_t locale_no_mac {
    (uint8_t*)ascii_no_mac, 128,
    (uint8_t*)utf8_no_mac, sizeof(utf8_no_mac) / 6,
    (uint8_t*)combinations_no_mac, sizeof(combinations_no_mac) / 8,
};