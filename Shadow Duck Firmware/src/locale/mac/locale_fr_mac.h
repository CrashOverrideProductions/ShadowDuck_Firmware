...
const uint8_t combinations_fr_mac[] = {
...
static hid_locale_t locale_fr_mac {
    (uint8_t*)ascii_fr_mac, 128,
    (uint8_t*)utf8_fr_mac, sizeof(utf8_fr_mac) / 6,
    (uint8_t*)combinations_fr_mac, sizeof(combinations_fr_mac) / 8,
};