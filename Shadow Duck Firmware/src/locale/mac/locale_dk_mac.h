...
const uint8_t ascii_dk_mac[] = {
    ...
    // 124, 0x7c
    KEY_MOD_LALT,       KEY_I,              // |
    (KEY_MOD_LALT|KEY_MOD_LSHIFT),KEY_9,    // }
    KEY_NONE,           KEY_NONE,           // ~
    KEY_NONE,           KEY_DELETE          // DEL
};

const uint8_t utf8_dk_mac[] = {
    0xC2, 0xA1, 0x00, 0x00, KEY_MOD_LALT,           KEY_1,              // ¡
    0xC2, 0xA2, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_4,       // ¢
    0xC2, 0xA3, 0x00, 0x00, KEY_MOD_LALT,           KEY_4,              // £
    0xC2, 0xA5, 0x00, 0x00, KEY_MOD_LALT,           KEY_Y,              // ¥
    0xC2, 0xA7, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_GRAVE,          // §
    0xC2, 0xA9, 0x00, 0x00, KEY_MOD_LALT,           KEY_G,              // ©
    0xC2, 0xAA, 0x00, 0x00, KEY_MOD_LALT,           KEY_A,              // ª
    0xC2, 0xAB, 0x00, 0x00, KEY_MOD_LALT,           KEY_H,              // «
    0xC2, 0xAC, 0x00, 0x00, KEY_MOD_LALT,           KEY_L,              // ¬
    0xC2, 0xAE, 0x00, 0x00, KEY_MOD_LALT,           KEY_R,              // ®
    0xC2, 0xAF, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_1,       // ¯
    0xC2, 0xB0, 0x00, 0x00, KEY_MOD_LALT,           KEY_Q,              // °
    0xC2, 0xB1, 0x00, 0x00, KEY_MOD_LALT,           KEY_MINUS,          // ±
    0xC2, 0xB5, 0x00, 0x00, KEY_MOD_LALT,           KEY_M,              // µ
    0xC2, 0xB6, 0x00, 0x00, KEY_MOD_LALT,           KEY_7,              // ¶
    0xC2, 0xB7, 0x00, 0x00, KEY_MOD_LALT,           KEY_DOT,            // ·
    0xC2, 0xB8, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_Z,       // ¸
    0xC2, 0xBA, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_BACKSLASH, // º
    0xC2, 0xBB, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_H,       // »
    0xC2, 0xBF, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_MINUS,   // ¿
    0xC3, 0x81, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_G,       // Á
    0xC3, 0x82, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_R,       // Â
    0xC3, 0x84, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_SEMICOLON, // Ä
    ...
    0xC3, 0x89, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_E,       // É
    0xC3, 0x8A, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_A,       // Ê
    0xC3, 0x8B, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_B,       // Ë
    0xC3, 0x91, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_N,       // Ñ
    0xC3, 0x96, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_APOSTROPHE, // Ö
    0xC3, 0x98, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_APOSTROPHE,     // Ø
    0xC3, 0x9C, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_U,       // Ü
    0xC3, 0x9F, 0x00, 0x00, KEY_MOD_LALT,           KEY_S,              // ß
    0xC3, 0xA4, 0x00, 0x00, KEY_MOD_LALT,           KEY_SEMICOLON,      // ä
    ...
    0xC3, 0xA9, 0x00, 0x00, KEY_MOD_LALT,           KEY_E,              // é
    0xC3, 0xB1, 0x00, 0x00, KEY_MOD_LALT,           KEY_N,              // ñ
    0xC3, 0xB6, 0x00, 0x00, KEY_MOD_LALT,           KEY_APOSTROPHE,     // ö
    0xC3, 0xB7, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_DOT,     // ÷
    0xC3, 0xB8, 0x00, 0x00, KEY_NONE,               KEY_APOSTROPHE,     // ø
    0xC3, 0xBC, 0x00, 0x00, KEY_MOD_LALT,           KEY_U,              // ü
    ...
    0xCB, 0x87, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_S,       // ˇ
    0xCB, 0x98, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_D,       // ˘
    0xCB, 0x99, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_X,       // ˙
    0xCB, 0x9A, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_W,       // ˚
    0xCB, 0x9B, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_M,       // ˛
    0xCB, 0x9C, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_6,       // ˜
    0xCB, 0x9D, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_K,       // ˝
    ...
    0xE2, 0x80, 0x98, 0x00, KEY_MOD_LALT,           KEY_LEFTBRACE,      // ‘
    0xE2, 0x80, 0x99, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_LEFTBRACE, // ’
    0xE2, 0x80, 0x9A, 0x00, KEY_MOD_LALT,           KEY_COMMA,          // ‚
    ...
    0xE2, 0x80, 0xA1, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_T,       // ‡
    0xE2, 0x80, 0xA2, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_Q,       // •
    0xE2, 0x80, 0xA6, 0x00, KEY_MOD_LALT,           KEY_X,              // …
    0xE2, 0x80, 0xB0, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_5,       // ‰
    0xE2, 0x80, 0xB9, 0x00, KEY_MOD_LALT,           KEY_J,              // ‹
    0xE2, 0x80, 0xBA, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_J,       // ›
    0xE2, 0x81, 0x84, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_EQUAL,   // ⁄
    0xE2, 0x82, 0xAC, 0x00, KEY_MOD_LSHIFT,         KEY_4,              // €
    0xE2, 0x84, 0xA2, 0x00, KEY_MOD_LALT,           KEY_6,              // ™
    ...
    0xEF, 0xA3, 0xBF, 0x00, KEY_MOD_LALT,           KEY_GRAVE,          // 
    0xEF, 0xAC, 0x81, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_F,       // ﬁ
    0xEF, 0xAC, 0x82, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_L,       // ﬂ
};

const uint8_t combinations_dk_mac[] = {
...
static hid_locale_t locale_dk_mac {
    (uint8_t*)ascii_dk_mac, 128,
    (uint8_t*)utf8_dk_mac, sizeof(utf8_dk_mac) / 6,
    (uint8_t*)combinations_dk_mac, sizeof(combinations_dk_mac) / 8,
};