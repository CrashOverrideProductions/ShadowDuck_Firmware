...
const uint8_t utf8_it_mac[] = {
    0xC2, 0xA1, 0x00, 0x00, KEY_MOD_LALT,           KEY_MINUS,          // ¡
    0xC2, 0xA2, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_4,       // ¢
    0xC2, 0xA3, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_3,              // £
    0xC2, 0xA5, 0x00, 0x00, KEY_MOD_LALT,           KEY_4,              // ¥
    0xC2, 0xA7, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_BACKSLASH,      // §
    0xC2, 0xA9, 0x00, 0x00, KEY_MOD_LALT,           KEY_C,              // ©
    0xC2, 0xAA, 0x00, 0x00, KEY_MOD_LALT,           KEY_J,              // ª
    0xC2, 0xAB, 0x00, 0x00, KEY_MOD_LALT,           KEY_1,              // «
    0xC2, 0xAC, 0x00, 0x00, KEY_MOD_LALT,           KEY_L,              // ¬
    0xC2, 0xAE, 0x00, 0x00, KEY_MOD_LALT,           KEY_R,              // ®
    0xC2, 0xAF, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_S,       // ¯
    ...
    0xC2, 0xB7, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_DOT,     // ·
    0xC2, 0xB8, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_H,       // ¸
    0xC2, 0xBA, 0x00, 0x00, KEY_MOD_LALT,           KEY_K,              // º
    0xC2, 0xBB, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_1,       // »
    0xC2, 0xBF, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_MINUS,   // ¿
    0xC3, 0x80, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_W,       // À
    0xC3, 0x81, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_C,       // Á
    0xC3, 0x85, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_A,       // Å
    0xC3, 0x86, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_Y,       // Æ
    0xC3, 0x87, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_SEMICOLON, // Ç
    0xC3, 0x88, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_E,       // È
    0xC3, 0x89, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_V,       // É
    0xC3, 0x8C, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_R,       // Ì
    0xC3, 0x8D, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_B,       // Í
    0xC3, 0x92, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_T,       // Ò
    0xC3, 0x93, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_N,       // Ó
    0xC3, 0x98, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_O,       // Ø
    0xC3, 0x99, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_U,       // Ù
    0xC3, 0x9A, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_M,       // Ú
    ...
    0xC3, 0xA6, 0x00, 0x00, KEY_MOD_LALT,           KEY_Y,              // æ
    ...
    0xC3, 0xB7, 0x00, 0x00, KEY_MOD_LALT,           KEY_7,              // ÷
    0xC3, 0xB8, 0x00, 0x00, KEY_MOD_LALT,           KEY_O,              // ø
    0xC3, 0xB9, 0x00, 0x00, KEY_NONE,               KEY_BACKSLASH,      // ù
    0xC4, 0xB1, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_GRAVE,   // ı
    0xC5, 0x92, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_I,       // Œ
    0xC5, 0x93, 0x00, 0x00, KEY_MOD_LALT,           KEY_I,              // œ
    0xC6, 0x92, 0x00, 0x00, KEY_MOD_LALT,           KEY_F,              // ƒ
    0xCB, 0x87, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_L,       // ˇ
    0xCB, 0x98, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_D,       // ˘
    0xCB, 0x99, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_F,       // ˙
    0xCB, 0x9A, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_G,       // ˚
    0xCB, 0x9B, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_K,       // ˛
    0xCB, 0x9D, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_J,       // ˝
    0xCE, 0xA9, 0x00, 0x00, KEY_MOD_LALT,           KEY_W,              // Ω
    ...
    0xE2, 0x80, 0x98, 0x00, KEY_MOD_LALT,           KEY_3,              // ‘
    0xE2, 0x80, 0x99, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_3,       // ’
    0xE2, 0x80, 0x9A, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_Q,       // ‚
    0xE2, 0x80, 0x9C, 0x00, KEY_MOD_LALT,           KEY_2,              // “
    0xE2, 0x80, 0x9D, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_2,       // ”
    0xE2, 0x80, 0x9E, 0x00, KEY_MOD_LALT,           KEY_Q,              // „
    0xE2, 0x80, 0xA0, 0x00, KEY_MOD_LALT,           KEY_X,              // †
    0xE2, 0x80, 0xA1, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_X,       // ‡
    0xE2, 0x80, 0xA2, 0x00, KEY_MOD_LALT,           KEY_DOT,            // •
    0xE2, 0x80, 0xA6, 0x00, KEY_MOD_LALT,           KEY_COMMA,          // …
    0xE2, 0x80, 0xB0, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_5,       // ‰
    0xE2, 0x80, 0xB9, 0x00, KEY_MOD_LALT,           KEY_6,              // ‹
    0xE2, 0x80, 0xBA, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_6,       // ›
    0xE2, 0x81, 0x84, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_7,       // ⁄
    0xE2, 0x82, 0xAC, 0x00, KEY_MOD_LALT,           KEY_E,              // €
    0xE2, 0x84, 0xA2, 0x00, KEY_MOD_LALT,           KEY_T,              // ™
    0xE2, 0x88, 0x82, 0x00, KEY_MOD_LALT,           KEY_D,              // ∂
    0xE2, 0x88, 0x86, 0x00, KEY_MOD_LALT,           KEY_H,              // ∆
    0xE2, 0x88, 0x8F, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_P,       // ∏
    0xE2, 0x88, 0x91, 0x00, KEY_MOD_LALT,           KEY_Z,              // ∑
    0xE2, 0x88, 0x9A, 0x00, KEY_MOD_LALT,           KEY_V,              // √
    0xE2, 0x88, 0x9E, 0x00, KEY_MOD_LALT,           KEY_G,              // ∞
    0xE2, 0x88, 0xAB, 0x00, KEY_MOD_LALT,           KEY_B,              // ∫
    0xE2, 0x89, 0x88, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_0,       // ≈
    ...
    0xE2, 0x97, 0x8A, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_BACKSLASH, // ◊
    0xEF, 0xA3, 0xBF, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_8,       // 
};

const uint8_t combinations_it_mac[] = {
    0xC2, 0xA8, 0x00, 0x00, KEY_MOD_LALT,           KEY_U,              KEY_NONE,           KEY_SPACE,          // ¨
    0xC2, 0xB4, 0x00, 0x00, KEY_MOD_LALT,           KEY_8,              KEY_NONE,           KEY_SPACE,          // ´
    0xC3, 0x82, 0x00, 0x00, KEY_MOD_LALT,           KEY_EQUAL,          KEY_MOD_LSHIFT,     KEY_A,              // Â
    ...
    0xC3, 0x8A, 0x00, 0x00, KEY_MOD_LALT,           KEY_EQUAL,          KEY_MOD_LSHIFT,     KEY_E,              // Ê
    0xC3, 0x8B, 0x00, 0x00, KEY_MOD_LALT,           KEY_U,              KEY_MOD_LSHIFT,     KEY_E,              // Ë
    0xC3, 0x8E, 0x00, 0x00, KEY_MOD_LALT,           KEY_EQUAL,          KEY_MOD_LSHIFT,     KEY_I,              // Î
    0xC3, 0x8F, 0x00, 0x00, KEY_MOD_LALT,           KEY_U,              KEY_MOD_LSHIFT,     KEY_I,              // Ï
    0xC3, 0x94, 0x00, 0x00, KEY_MOD_LALT,           KEY_EQUAL,          KEY_MOD_LSHIFT,     KEY_O,              // Ô
    ...
    0xC3, 0x9B, 0x00, 0x00, KEY_MOD_LALT,           KEY_EQUAL,          KEY_MOD_LSHIFT,     KEY_U,              // Û
    0xC3, 0xA1, 0x00, 0x00, KEY_MOD_LALT,           KEY_8,              KEY_NONE,           KEY_A,              // á
    0xC3, 0xA2, 0x00, 0x00, KEY_MOD_LALT,           KEY_EQUAL,          KEY_NONE,           KEY_A,              // â
    0xC3, 0xA3, 0x00, 0x00, KEY_MOD_LALT,           KEY_N,              KEY_NONE,           KEY_A,              // ã
    0xC3, 0xA4, 0x00, 0x00, KEY_MOD_LALT,           KEY_U,              KEY_NONE,           KEY_A,              // ä
    0xC3, 0xAA, 0x00, 0x00, KEY_MOD_LALT,           KEY_EQUAL,          KEY_NONE,           KEY_E,              // ê
    0xC3, 0xAB, 0x00, 0x00, KEY_MOD_LALT,           KEY_U,              KEY_NONE,           KEY_E,              // ë
    0xC3, 0xAD, 0x00, 0x00, KEY_MOD_LALT,           KEY_8,              KEY_NONE,           KEY_I,              // í
    0xC3, 0xAE, 0x00, 0x00, KEY_MOD_LALT,           KEY_EQUAL,          KEY_NONE,           KEY_I,              // î
    0xC3, 0xAF, 0x00, 0x00, KEY_MOD_LALT,           KEY_U,              KEY_NONE,           KEY_I,              // ï
    0xC3, 0xB3, 0x00, 0x00, KEY_MOD_LALT,           KEY_8,              KEY_NONE,           KEY_O,              // ó
    0xC3, 0xB4, 0x00, 0x00, KEY_MOD_LALT,           KEY_EQUAL,          KEY_NONE,           KEY_O,              // ô
    0xC3, 0xB5, 0x00, 0x00, KEY_MOD_LALT,           KEY_N,              KEY_NONE,           KEY_O,              // õ
    0xC3, 0xB6, 0x00, 0x00, KEY_MOD_LALT,           KEY_U,              KEY_NONE,           KEY_O,              // ö
    0xC3, 0xBA, 0x00, 0x00, KEY_MOD_LALT,           KEY_8,              KEY_NONE,           KEY_U,              // ú
    0xC3, 0xBB, 0x00, 0x00, KEY_MOD_LALT,           KEY_EQUAL,          KEY_NONE,           KEY_U,              // û
    0xC3, 0xBF, 0x00, 0x00, KEY_MOD_LALT,           KEY_U,              KEY_NONE,           KEY_Y,              // ÿ
    0xC5, 0xB8, 0x00, 0x00, KEY_MOD_LALT,           KEY_U,              KEY_MOD_LSHIFT,     KEY_Y,              // Ÿ
    0xCB, 0x86, 0x00, 0x00, KEY_MOD_LALT,           KEY_EQUAL,          KEY_NONE,           KEY_SPACE,          // ˆ
    0xCB, 0x9C, 0x00, 0x00, KEY_MOD_LALT,           KEY_N,              KEY_NONE,           KEY_SPACE,          // ˜
};

static hid_locale_t locale_it_mac {
    (uint8_t*)ascii_it_mac, 128,
    (uint8_t*)utf8_it_mac, sizeof(utf8_it_mac) / 6,
    (uint8_t*)combinations_it_mac, sizeof(combinations_it_mac) / 8,
};