...
const uint8_t utf8_gr_mac[] = {
    ...
    0xC2, 0xAD, 0x00, 0x00, KEY_MOD_LALT,           KEY_U,              // ­
    0xC2, 0xAE, 0x00, 0x00, KEY_MOD_LALT,           KEY_R,              // ®
    0xC2, 0xB0, 0x00, 0x00, KEY_MOD_LALT,           KEY_7,              // °
    0xC2, 0xB1, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_GRAVE,          // ±
    0xC2, 0xB2, 0x00, 0x00, KEY_MOD_LALT,           KEY_2,              // ²
    0xC2, 0xB3, 0x00, 0x00, KEY_MOD_LALT,           KEY_3,              // ³
    0xC2, 0xB6, 0x00, 0x00, KEY_MOD_LALT,           KEY_6,              // ¶
    0xC2, 0xB7, 0x00, 0x00, KEY_MOD_LALT,           KEY_Q,              // ·
    0xC2, 0xB9, 0x00, 0x00, KEY_MOD_LALT,           KEY_1,              // ¹
    0xC2, 0xBB, 0x00, 0x00, KEY_MOD_LALT,           KEY_RIGHTBRACE,     // »
    0xC2, 0xBD, 0x00, 0x00, KEY_MOD_LALT,           KEY_H,              // ½
    0xC3, 0x9F, 0x00, 0x00, KEY_MOD_LALT,           KEY_S,              // ß
    0xC3, 0xA7, 0x00, 0x00, KEY_MOD_LALT,           KEY_C,              // ç
    0xC3, 0xB7, 0x00, 0x00, KEY_MOD_LALT,           KEY_D,              // ÷
    0xC5, 0x93, 0x00, 0x00, KEY_MOD_LALT,           KEY_O,              // œ
    0xCE, 0x86, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_V,       // Ά
    0xCE, 0x88, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_E,       // Έ
    0xCE, 0x8C, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_N,       // Ό
    0xCE, 0x8E, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_M,       // Ύ
    0xCE, 0x8F, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_5,       // Ώ
    ...
    0xCE, 0xAA, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_G,       // Ϊ
    0xCE, 0xAC, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_A,       // ά
    0xCE, 0xAD, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_1,       // έ
    0xCE, 0xAE, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_3,       // ή
    0xCE, 0xAF, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_2,       // ί
    ...
    0xCF, 0x8C, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_4,       // ό
    0xCF, 0x8D, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_0,       // ύ
    0xCF, 0x8E, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_DOT,     // ώ
    0xE2, 0x80, 0x95, 0x00, KEY_MOD_LALT,           KEY_W,              // ―
    0xE2, 0x80, 0x98, 0x00, KEY_MOD_LALT,           KEY_N,              // ‘
    0xE2, 0x80, 0x99, 0x00, KEY_MOD_LALT,           KEY_M,              // ’
    0xE2, 0x80, 0x9C, 0x00, KEY_MOD_LALT,           KEY_9,              // “
    0xE2, 0x80, 0xA0, 0x00, KEY_MOD_LALT,           KEY_I,              // †
    0xE2, 0x80, 0xA2, 0x00, KEY_MOD_LALT,           KEY_8,              // •
    0xE2, 0x80, 0xA6, 0x00, KEY_MOD_LALT,           KEY_A,              // …
    0xE2, 0x82, 0xAC, 0x00, KEY_MOD_LALT,           KEY_E,              // €
    0xE2, 0x84, 0xA2, 0x00, KEY_MOD_LALT,           KEY_T,              // ™
    0xE2, 0x89, 0x88, 0x00, KEY_MOD_LALT,           KEY_P,              // ≈
    0xE2, 0x89, 0xA0, 0x00, KEY_MOD_LALT,           KEY_F,              // ≠
    0xE2, 0x89, 0xA4, 0x00, KEY_MOD_LALT,           KEY_J,              // ≤
    0xE2, 0x89, 0xA5, 0x00, KEY_MOD_LALT,           KEY_K,              // ≥
};

const uint8_t combinations_gr_mac[] = {
...
static hid_locale_t locale_gr_mac {
    (uint8_t*)ascii_gr_mac, 128,
    (uint8_t*)utf8_gr_mac, sizeof(utf8_gr_mac) / 6,
    (uint8_t*)combinations_gr_mac, sizeof(combinations_gr_mac) / 8,
};