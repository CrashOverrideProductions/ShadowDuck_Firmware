...
const uint8_t utf8_ca_fr_mac[] = {
    0xC2, 0xA0, 0x00, 0x00, KEY_MOD_LALT,           KEY_L,              //  
    0xC2, 0xA1, 0x00, 0x00, KEY_MOD_LALT,           KEY_1,              // ¡
    0xC2, 0xA2, 0x00, 0x00, KEY_MOD_LALT,           KEY_C,              // ¢
    0xC2, 0xA3, 0x00, 0x00, KEY_MOD_LALT,           KEY_3,              // £
    0xC2, 0xA5, 0x00, 0x00, KEY_MOD_LALT,           KEY_Y,              // ¥
    0xC2, 0xA7, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_S,       // §
    0xC2, 0xA9, 0x00, 0x00, KEY_MOD_LALT,           KEY_G,              // ©
    0xC2, 0xAA, 0x00, 0x00, KEY_MOD_LALT,           KEY_D,              // ª
    0xC2, 0xAB, 0x00, 0x00, KEY_MOD_LALT,           KEY_Z,              // «
    0xC2, 0xAC, 0x00, 0x00, KEY_MOD_LALT,           KEY_EQUAL,          // ¬
    0xC2, 0xAE, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_R,       // ®
    0xC2, 0xAF, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_E,       // ¯
    0xC2, 0xB0, 0x00, 0x00, KEY_MOD_LALT,           KEY_SEMICOLON,      // °
    0xC2, 0xB1, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_9,       // ±
    ...
    0xC2, 0xBA, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_M,       // º
    0xC2, 0xBB, 0x00, 0x00, KEY_MOD_LALT,           KEY_X,              // »
    0xC2, 0xBF, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_MINUS,   // ¿
    0xC3, 0x80, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_BACKSLASH,      // À
    0xC3, 0x86, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_A,       // Æ
    ...
    0xC3, 0xA6, 0x00, 0x00, KEY_MOD_LALT,           KEY_A,              // æ
    ...
    0xC4, 0xB1, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_2,       // ı
    ...
    0xCB, 0x86, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_3,       // ˆ
    0xCB, 0x87, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_D,       // ˇ
    0xCB, 0x98, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_T,       // ˘
    0xCB, 0x99, 0x00, 0x00, KEY_MOD_LALT,           KEY_H,              // ˙
    0xCB, 0x9A, 0x00, 0x00, KEY_MOD_LALT,           KEY_K,              // ˚
    0xCB, 0x9B, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_U,       // ˛
    0xCB, 0x9C, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_4,       // ˜
    0xCB, 0x9D, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_Y,       // ˝
    0xCE, 0xA9, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_102ND,   // Ω
    0xCF, 0x80, 0x00, 0x00, KEY_MOD_LALT,           KEY_I,              // π
    0xE2, 0x80, 0x93, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_EQUAL,   // –
    0xE2, 0x80, 0x94, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_0,       // —
    0xE2, 0x80, 0x9A, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_J,       // ‚
    0xE2, 0x80, 0x9C, 0x00, KEY_MOD_LALT,           KEY_P,              // “
    0xE2, 0x80, 0x9D, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_P,       // ”
    0xE2, 0x80, 0x9E, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_LEFTBRACE, // „
    0xE2, 0x80, 0xA0, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_6,       // †
    0xE2, 0x80, 0xA1, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_7,       // ‡
    0xE2, 0x80, 0xA2, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_8,       // •
    0xE2, 0x80, 0xA6, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_L,       // …
    0xE2, 0x80, 0xB0, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_W,       // ‰
    0xE2, 0x80, 0xB9, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_Z,       // ‹
    0xE2, 0x80, 0xBA, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_X,       // ›
    0xE2, 0x81, 0x84, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_K,       // ⁄
    0xE2, 0x82, 0xAC, 0x00, KEY_MOD_LALT,           KEY_4,              // €
    0xE2, 0x84, 0xA2, 0x00, KEY_MOD_LALT,           KEY_T,              // ™
    0xE2, 0x88, 0x82, 0x00, KEY_MOD_LALT,           KEY_E,              // ∂
    0xE2, 0x88, 0x86, 0x00, KEY_MOD_LALT,           KEY_J,              // ∆
    0xE2, 0x88, 0x8F, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_I,       // ∏
    ...
    0xE2, 0x89, 0x88, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_1,       // ≈
    0xE2, 0x89, 0xA0, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_SLASH,   // ≠
    0xE2, 0x89, 0xA4, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_B,       // ≤
    0xE2, 0x89, 0xA5, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_N,       // ≥
    0xE2, 0x97, 0x8A, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_V,       // ◊
    0xEF, 0xA3, 0xBF, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_5,       // 
    0xEF, 0xAC, 0x81, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_G,       // ﬁ
    0xEF, 0xAC, 0x82, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_F,       // ﬂ
};

const uint8_t combinations_ca_fr_mac[] = {
    ...
    0xC2, 0xB4, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_SEMICOLON, KEY_NONE,         KEY_SPACE,          // ´
    0xC3, 0x81, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_SEMICOLON, KEY_MOD_LSHIFT,   KEY_A,              // Á
    0xC3, 0x82, 0x00, 0x00, KEY_NONE,               KEY_LEFTBRACE,      KEY_MOD_LSHIFT,     KEY_A,              // Â
    0xC3, 0x83, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_RIGHTBRACE, KEY_MOD_LSHIFT,  KEY_A,              // Ã
    ...
    0xC3, 0x8C, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_BACKSLASH, KEY_MOD_LSHIFT,   KEY_I,              // Ì
    0xC3, 0x8D, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_SEMICOLON, KEY_MOD_LSHIFT,   KEY_I,              // Í
    ...
    0xC3, 0x91, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_RIGHTBRACE, KEY_MOD_LSHIFT,  KEY_N,              // Ñ
    0xC3, 0x92, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_BACKSLASH, KEY_MOD_LSHIFT,   KEY_O,              // Ò
    0xC3, 0x93, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_SEMICOLON, KEY_MOD_LSHIFT,   KEY_O,              // Ó
    0xC3, 0x94, 0x00, 0x00, KEY_NONE,               KEY_LEFTBRACE,      KEY_MOD_LSHIFT,     KEY_O,              // Ô
    0xC3, 0x95, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_RIGHTBRACE, KEY_MOD_LSHIFT,  KEY_O,              // Õ
    0xC3, 0x96, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_LEFTBRACE,      KEY_MOD_LSHIFT,     KEY_O,              // Ö
    0xC3, 0x9A, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_SEMICOLON, KEY_MOD_LSHIFT,   KEY_U,              // Ú
    ...
    0xC3, 0xA1, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_SEMICOLON, KEY_NONE,         KEY_A,              // á
    0xC3, 0xA2, 0x00, 0x00, KEY_NONE,               KEY_LEFTBRACE,      KEY_NONE,           KEY_A,              // â
    0xC3, 0xA3, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_RIGHTBRACE, KEY_NONE,        KEY_A,              // ã
    ...
    0xC3, 0xAC, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_BACKSLASH, KEY_NONE,         KEY_I,              // ì
    0xC3, 0xAD, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_SEMICOLON, KEY_NONE,         KEY_I,              // í
    ...
    0xC3, 0xB1, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_RIGHTBRACE, KEY_NONE,        KEY_N,              // ñ
    0xC3, 0xB2, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_BACKSLASH, KEY_NONE,         KEY_O,              // ò
    0xC3, 0xB3, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_SEMICOLON, KEY_NONE,         KEY_O,              // ó
    0xC3, 0xB4, 0x00, 0x00, KEY_NONE,               KEY_LEFTBRACE,      KEY_NONE,           KEY_O,              // ô
    0xC3, 0xB5, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_RIGHTBRACE, KEY_NONE,        KEY_O,              // õ
    0xC3, 0xB6, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_LEFTBRACE,      KEY_NONE,           KEY_O,              // ö
    0xC3, 0xBA, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_SEMICOLON, KEY_NONE,         KEY_U,              // ú
...
static hid_locale_t locale_ca_fr_mac {
    (uint8_t*)ascii_ca_fr_mac, 128,
    (uint8_t*)utf8_ca_fr_mac, sizeof(utf8_ca_fr_mac) / 6,
    (uint8_t*)combinations_ca_fr_mac, sizeof(combinations_ca_fr_mac) / 8,
};