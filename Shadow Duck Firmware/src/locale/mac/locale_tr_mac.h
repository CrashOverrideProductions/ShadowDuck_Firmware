...
const uint8_t utf8_tr_mac[] = {
    0xC2, 0xA3, 0x00, 0x00, KEY_MOD_LALT,           KEY_2,              // £
    0xC2, 0xA5, 0x00, 0x00, KEY_MOD_LALT,           KEY_Y,              // ¥
    0xC2, 0xA7, 0x00, 0x00, KEY_MOD_LALT,           KEY_6,              // §
    0xC2, 0xA8, 0x00, 0x00, KEY_MOD_LALT,           KEY_K,              // ¨
    0xC2, 0xA9, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_3,       // ©
    0xC2, 0xAC, 0x00, 0x00, KEY_MOD_LALT,           KEY_L,              // ¬
    0xC2, 0xAE, 0x00, 0x00, KEY_MOD_LALT,           KEY_R,              // ®
    0xC2, 0xAF, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_COMMA,   // ¯
    ...
    0xC2, 0xB7, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_1,       // ·
    0xC2, 0xBB, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_BACKSLASH, // »
    0xC2, 0xBD, 0x00, 0x00, KEY_MOD_LALT,           KEY_5,              // ½
    0xC2, 0xBF, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_SLASH,   // ¿
    0xC3, 0x81, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_Y,       // Á
    0xC3, 0x82, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_R,       // Â
    0xC3, 0x86, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_A,       // Æ
    0xC3, 0x87, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_DOT,            // Ç
    0xC3, 0x8A, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_T,       // Ê
    ...
    0xC3, 0x96, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_COMMA,          // Ö
    0xC3, 0x98, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_9,       // Ø
    0xC3, 0x99, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_X,       // Ù
    0xC3, 0x9A, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_SEMICOLON, // Ú
    0xC3, 0x9B, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_Z,       // Û
    0xC3, 0x9C, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_RIGHTBRACE,     // Ü
    0xC3, 0x9F, 0x00, 0x00, KEY_MOD_LALT,           KEY_S,              // ß
    0xC3, 0xA6, 0x00, 0x00, KEY_MOD_LALT,           KEY_A,              // æ
    0xC3, 0xA7, 0x00, 0x00, KEY_NONE,               KEY_DOT,            // ç
    0xC3, 0xA9, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_GRAVE,          // é
    0xC3, 0xB6, 0x00, 0x00, KEY_NONE,               KEY_COMMA,          // ö
    0xC3, 0xB7, 0x00, 0x00, KEY_MOD_LALT,           KEY_SLASH,          // ÷
    0xC3, 0xB8, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_0,       // ø
    0xC3, 0xBC, 0x00, 0x00, KEY_NONE,               KEY_RIGHTBRACE,     // ü
    0xC4, 0x9E, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_LEFTBRACE,      // Ğ
    0xC4, 0x9F, 0x00, 0x00, KEY_NONE,               KEY_LEFTBRACE,      // ğ
    0xC4, 0xB0, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_APOSTROPHE,     // İ
    0xC4, 0xB1, 0x00, 0x00, KEY_NONE,               KEY_I,              // ı
    0xC5, 0x92, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_Q,       // Œ
    0xC5, 0x9E, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_SEMICOLON,      // Ş
    0xC5, 0x9F, 0x00, 0x00, KEY_NONE,               KEY_SEMICOLON,      // ş
    0xC5, 0xB8, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_102ND,   // Ÿ
    0xC6, 0x92, 0x00, 0x00, KEY_MOD_LALT,           KEY_F,              // ƒ
    0xCB, 0x86, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_N,       // ˆ
    0xCB, 0x98, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_DOT,     // ˘
    0xCB, 0x99, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_6,       // ˙
    0xCB, 0x9A, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_5,       // ˚
    0xCB, 0x9C, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_M,       // ˜
    ...
    0xE2, 0x80, 0x9A, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_4,       // ‚
    ...
    0xE2, 0x82, 0xBA, 0x00, KEY_MOD_LALT,           KEY_T,              // ₺
...
const uint8_t combinations_tr_mac[] = {
    0x60, 0x00, 0x00, 0x00, KEY_MOD_LALT,           KEY_BACKSLASH,      KEY_NONE,           KEY_SPACE,          // `
    0xC2, 0xB4, 0x00, 0x00, KEY_MOD_LALT,           KEY_SEMICOLON,      KEY_NONE,           KEY_SPACE,          // ´
    0xC3, 0x80, 0x00, 0x00, KEY_MOD_LALT,           KEY_BACKSLASH,      KEY_MOD_LSHIFT,     KEY_A,              // À
    0xC3, 0x84, 0x00, 0x00, KEY_MOD_LALT,           KEY_LEFTBRACE,      KEY_MOD_LSHIFT,     KEY_A,              // Ä
    0xC3, 0x88, 0x00, 0x00, KEY_MOD_LALT,           KEY_BACKSLASH,      KEY_MOD_LSHIFT,     KEY_E,              // È
    0xC3, 0x89, 0x00, 0x00, KEY_MOD_LALT,           KEY_SEMICOLON,      KEY_MOD_LSHIFT,     KEY_E,              // É
    0xC3, 0x8B, 0x00, 0x00, KEY_MOD_LALT,           KEY_LEFTBRACE,      KEY_MOD_LSHIFT,     KEY_E,              // Ë
    0xC3, 0x8C, 0x00, 0x00, KEY_MOD_LALT,           KEY_BACKSLASH,      KEY_MOD_LSHIFT,     KEY_I,              // Ì
    0xC3, 0x8D, 0x00, 0x00, KEY_MOD_LALT,           KEY_SEMICOLON,      KEY_MOD_LSHIFT,     KEY_I,              // Í
    0xC3, 0xA0, 0x00, 0x00, KEY_MOD_LALT,           KEY_BACKSLASH,      KEY_NONE,           KEY_A,              // à
    0xC3, 0xA1, 0x00, 0x00, KEY_MOD_LALT,           KEY_SEMICOLON,      KEY_NONE,           KEY_A,              // á
    0xC3, 0xA2, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_3,              KEY_NONE,           KEY_A,              // â
    0xC3, 0xA4, 0x00, 0x00, KEY_MOD_LALT,           KEY_LEFTBRACE,      KEY_NONE,           KEY_A,              // ä
    0xC3, 0xA8, 0x00, 0x00, KEY_MOD_LALT,           KEY_BACKSLASH,      KEY_NONE,           KEY_E,              // è
    0xC3, 0xAA, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_3,              KEY_NONE,           KEY_E,              // ê
    0xC3, 0xAB, 0x00, 0x00, KEY_MOD_LALT,           KEY_LEFTBRACE,      KEY_NONE,           KEY_E,              // ë
    0xC3, 0xB2, 0x00, 0x00, KEY_MOD_LALT,           KEY_BACKSLASH,      KEY_NONE,           KEY_O,              // ò
    0xC3, 0xB3, 0x00, 0x00, KEY_MOD_LALT,           KEY_SEMICOLON,      KEY_NONE,           KEY_O,              // ó
    0xC3, 0xB4, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_3,              KEY_NONE,           KEY_O,              // ô
    0xC3, 0xB9, 0x00, 0x00, KEY_MOD_LALT,           KEY_BACKSLASH,      KEY_NONE,           KEY_U,              // ù
    0xC3, 0xBA, 0x00, 0x00, KEY_MOD_LALT,           KEY_SEMICOLON,      KEY_NONE,           KEY_U,              // ú
    0xC3, 0xBB, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_3,              KEY_NONE,           KEY_U,              // û
};

static hid_locale_t locale_tr_mac {
    (uint8_t*)ascii_tr_mac, 128,
    (uint8_t*)utf8_tr_mac, sizeof(utf8_tr_mac) / 6,
    (uint8_t*)combinations_tr_mac, sizeof(combinations_tr_mac) / 8,
};