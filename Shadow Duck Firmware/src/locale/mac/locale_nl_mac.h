...
const uint8_t utf8_nl_mac[] = {
    ...
    0xC3, 0x88, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_I,       // È
    0xC3, 0x8A, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_T,       // Ê
    0xC3, 0x8B, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_U,       // Ë
    ...
    0xE2, 0x82, 0xAC, 0x00, KEY_MOD_LALT,           KEY_2,              // €
    0xE2, 0x84, 0xA2, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_2,       // ™
...
const uint8_t combinations_nl_mac[] = {
    ...
    0xC3, 0xAC, 0x00, 0x00, KEY_MOD_LALT,           KEY_102ND,          KEY_NONE,           KEY_I,              // ì
...
static hid_locale_t locale_nl_mac {
    (uint8_t*)ascii_nl_mac, 128,
    (uint8_t*)utf8_nl_mac, sizeof(utf8_nl_mac) / 6,
    (uint8_t*)combinations_nl_mac, sizeof(combinations_nl_mac) / 8,
};