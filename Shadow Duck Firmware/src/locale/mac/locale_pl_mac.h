...
const uint8_t utf8_pl_mac[] = {
    0xC2, 0xA3, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_GRAVE,          // £
    ...
    0xC3, 0x9F, 0x00, 0x00, KEY_MOD_LALT,           KEY_4,              // ß
    0xC3, 0xB3, 0x00, 0x00, KEY_MOD_LALT,           KEY_O,              // ó
    ...
    0xC4, 0x86, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_C,       // Ć
    ...
    0xC4, 0xAF, 0x00, 0x00, KEY_MOD_LALT,           KEY_5,              // į
    ...
    0xC5, 0x9A, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_S,       // Ś
    0xC5, 0x9B, 0x00, 0x00, KEY_MOD_LALT,           KEY_S,              // ś
    0xC5, 0xA0, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_9,       // Š
    0xC5, 0xA4, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_U,       // Ť
    0xC5, 0xA5, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_I,       // ť
    0xC5, 0xAA, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_G,       // Ū
    0xC5, 0xAB, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_K,       // ū
    0xC5, 0xB1, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_B,       // ű
    0xC5, 0xB3, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_M,       // ų
    0xC5, 0xB9, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_X,       // Ź
    0xC5, 0xBA, 0x00, 0x00, KEY_MOD_LALT,           KEY_X,              // ź
    0xC5, 0xBB, 0x00, 0x00, KEY_MOD_LALT,           KEY_K,              // Ż
    0xC5, 0xBC, 0x00, 0x00, KEY_MOD_LALT,           KEY_Z,              // ż
    ...
    0xE2, 0x80, 0x9A, 0x00, KEY_MOD_LALT,           KEY_RIGHTBRACE,     // ‚
...
const uint8_t combinations_pl_mac[] = {
    ...
    0xC4, 0x8C, 0x00, 0x00, KEY_MOD_LALT,           KEY_I,              KEY_NONE,           KEY_A,              // Č
    0xC4, 0x8E, 0x00, 0x00, KEY_MOD_LALT,           KEY_U,              KEY_NONE,           KEY_E,              // Ď
    0xC4, 0x8F, 0x00, 0x00, KEY_MOD_LALT,           KEY_102ND,          KEY_NONE,           KEY_I,              // ď
    0xC4, 0x93, 0x00, 0x00, KEY_MOD_LALT,           KEY_U,              KEY_NONE,           KEY_I,              // ē
    0xC4, 0x97, 0x00, 0x00, KEY_MOD_LALT,           KEY_102ND,          KEY_NONE,           KEY_O,              // ė
    0xC4, 0x9A, 0x00, 0x00, KEY_MOD_LALT,           KEY_102ND,          KEY_NONE,           KEY_U,              // Ě
    0xC4, 0x9B, 0x00, 0x00, KEY_MOD_LALT,           KEY_I,              KEY_NONE,           KEY_U,              // ě
    0xC5, 0x88, 0x00, 0x00, KEY_MOD_LALT,           KEY_102ND,          KEY_MOD_LSHIFT,     KEY_A,              // ň
    0xC5, 0x8D, 0x00, 0x00, KEY_MOD_LALT,           KEY_U,              KEY_NONE,           KEY_Y,              // ō
    0xC5, 0xAE, 0x00, 0x00, KEY_MOD_LALT,           KEY_102ND,          KEY_MOD_LSHIFT,     KEY_O,              // Ů
    0xC5, 0xAF, 0x00, 0x00, KEY_MOD_LALT,           KEY_I,              KEY_MOD_LSHIFT,     KEY_U,              // ů
    0xC5, 0xB0, 0x00, 0x00, KEY_MOD_LALT,           KEY_102ND,          KEY_MOD_LSHIFT,     KEY_U,              // Ű
};

static hid_locale_t locale_pl_mac {
    (uint8_t*)ascii_pl_mac, 128,
    (uint8_t*)utf8_pl_mac, sizeof(utf8_pl_mac) / 6,
    (uint8_t*)combinations_pl_mac, sizeof(combinations_pl_mac) / 8,
};