...
const uint8_t combinations_us_mac[] = {
    ...
    0xCC, 0x81, 0x00, 0x00, KEY_MOD_LALT,           KEY_E,              KEY_NONE,           KEY_J,              // ́
};

static hid_locale_t locale_us_mac {
    (uint8_t*)ascii_us_mac, 128,
    (uint8_t*)utf8_us_mac, sizeof(utf8_us_mac) / 6,
    (uint8_t*)combinations_us_mac, sizeof(combinations_us_mac) / 8,
};