...
const uint8_t utf8_pt_mac[] = {
    ...
    0xC2, 0xAA, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_LEFTBRACE,      // ª
    0xC2, 0xAB, 0x00, 0x00, KEY_MOD_LALT,           KEY_X,              // «
    0xC2, 0xAC, 0x00, 0x00, KEY_MOD_LALT,           KEY_N,              // ¬
    0xC2, 0xAE, 0x00, 0x00, KEY_MOD_LALT,           KEY_R,              // ®
    0xC2, 0xAF, 0x00, 0x00, KEY_MOD_LALT,           KEY_J,              // ¯
    0xC2, 0xB0, 0x00, 0x00, KEY_MOD_LALT,           KEY_LEFTBRACE,      // °
    ...
    0xC2, 0xB8, 0x00, 0x00, KEY_MOD_LALT,           KEY_SEMICOLON,      // ¸
    0xC2, 0xBA, 0x00, 0x00, KEY_NONE,               KEY_LEFTBRACE,      // º
    ...
    0xC3, 0x86, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_E,       // Æ
    ...
    0xC3, 0xA6, 0x00, 0x00, KEY_MOD_LALT,           KEY_E,              // æ
    ...
    0xCB, 0x87, 0x00, 0x00, KEY_MOD_LALT,           KEY_H,              // ˇ
    0xCB, 0x99, 0x00, 0x00, KEY_MOD_LALT,           KEY_G,              // ˙
    0xCB, 0x9A, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_I,       // ˚
    0xCB, 0x9B, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_SEMICOLON, // ˛
    0xCB, 0x9D, 0x00, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_RIGHTBRACE, // ˝
    0xCE, 0xA9, 0x00, 0x00, KEY_MOD_LALT,           KEY_Z,              // Ω
    0xCF, 0x80, 0x00, 0x00, KEY_MOD_LALT,           KEY_P,              // π
    0xE2, 0x80, 0x93, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_SLASH,   // –
    0xE2, 0x80, 0x94, 0x00, KEY_MOD_LALT,           KEY_SLASH,          // —
    0xE2, 0x80, 0x98, 0x00, KEY_MOD_LALT,           KEY_L,              // ‘
    0xE2, 0x80, 0x99, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_L,       // ’
    0xE2, 0x80, 0x9A, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_K,       // ‚
    0xE2, 0x80, 0x9C, 0x00, KEY_MOD_LALT,           KEY_COMMA,          // “
    0xE2, 0x80, 0x9D, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_COMMA,   // ”
    0xE2, 0x80, 0x9E, 0x00, KEY_MOD_LALT,           KEY_K,              // „
    0xE2, 0x80, 0xA0, 0x00, KEY_MOD_LALT,           KEY_U,              // †
    0xE2, 0x80, 0xA1, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_U,       // ‡
    0xE2, 0x80, 0xA2, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_6,       // •
    0xE2, 0x80, 0xA6, 0x00, KEY_MOD_LALT,           KEY_DOT,            // …
    0xE2, 0x80, 0xB0, 0x00, KEY_MOD_LALT,           KEY_5,              // ‰
    0xE2, 0x80, 0xB9, 0x00, KEY_MOD_LALT,           KEY_BACKSLASH,      // ‹
    0xE2, 0x80, 0xBA, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_BACKSLASH, // ›
    0xE2, 0x81, 0x84, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_7,       // ⁄
    0xE2, 0x82, 0xAC, 0x00, KEY_MOD_LALT,           KEY_3,              // €
    ...
    0xE2, 0x97, 0x8A, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_EQUAL,   // ◊
    0xEF, 0xA3, 0xBF, 0x00, KEY_MOD_LALT,           KEY_1,              // 
    0xEF, 0xAC, 0x81, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_2,       // ﬁ
    0xEF, 0xAC, 0x82, 0x00, (KEY_MOD_LALT|KEY_MOD_LSHIFT), KEY_3,       // ﬂ
};

const uint8_t combinations_pt_mac[] = {
    0x5E, 0x00, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_APOSTROPHE,     KEY_NONE,           KEY_SPACE,          // ^
    0x60, 0x00, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_RIGHTBRACE,     KEY_NONE,           KEY_SPACE,          // `
    0x7E, 0x00, 0x00, 0x00, KEY_NONE,               KEY_APOSTROPHE,     KEY_NONE,           KEY_SPACE,          // ~
...
static hid_locale_t locale_pt_mac {
    (uint8_t*)ascii_pt_mac, 128,
    (uint8_t*)utf8_pt_mac, sizeof(utf8_pt_mac) / 6,
    (uint8_t*)combinations_pt_mac, sizeof(combinations_pt_mac) / 8,
};